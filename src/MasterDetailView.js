...
const MasterDetailView = (props) => {
  const renderOrdersTab = useCallback(() => <OrdersTab supplierId={props.data.key} />, [props.data.key]);
  const renderAddressTab = useCallback(() => <AddressTab data={props.data.data} />, [props.data.data]);
  return (
    <TabPanel>
